...
public class ScxSerializeTest {
    ...
    public static void test4() {
        int i = ScxSerialize.fromJson("[123]", int.class, new FromJsonOptions().singleValueArrayCompatibility(true));
        int i1 = ScxSerialize.fromJson("123", int.class);
        int[] i2 = ScxSerialize.fromJson("[123]", int[].class);
        int[] i3 = ScxSerialize.fromJson("123", int[].class, new FromJsonOptions().singleValueArrayCompatibility(true));
    }
