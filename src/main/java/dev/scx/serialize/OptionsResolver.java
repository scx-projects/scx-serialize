...
final class OptionsResolver {
    ...
    public static DefaultObjectNodeConvertOptions resolve(NodeToObjectOptions options) {
        ...
        var useAnnotations = options.useAnnotations();
        var numberConversionPolicy = options.numberConversionPolicy();
        var primitiveNullPolicy = options.primitiveNullPolicy();
        var singleValueArrayCompatibility = options.singleValueArrayCompatibility();
        ...
        result.addMapperOptions(numberConversionPolicy);
        result.addMapperOptions(primitiveNullPolicy);

        if (singleValueArrayCompatibility) {
